...
public class Add_Product_Page extends AppCompatActivity {
    ...
    EditText itemName, itemDesc, itemPrice;
    @Override
...
//        dialog.dismiss();
    ...
    public void uploadData(){
        String shopName="ShanthaBeakry";
        String productID="6635";
        ...
        Upload_Item_Details uploadItemDetails = new Upload_Item_Details(productName,productDescription,productPrice,imageURL);
